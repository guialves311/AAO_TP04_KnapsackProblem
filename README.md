...
- `DATA_FILE = 'src\\data\\instances\\n_1000_1.txt'`: Path to the data file containing the problem instances.
- `NUM_ITERATIONS = 1000`: Number of iterations for the algorithm.
- `TEMPERATURE = 10000000`: Initial temperature for simulated annealing.
